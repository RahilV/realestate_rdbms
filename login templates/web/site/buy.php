    ...
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm bg-color transparent">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <form action="search2.php" method="POST">
            <input type="text" name="search" placeholder="Search.." id="search" style="color: white;" />
          </form>
            <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true"><li class="nav-item">
                    <a class="nav-link link text-black display-4" href="buy.html"><span class="mbri-shopping-basket mbr-iconfont mbr-iconfont-btn"></span>
                        &nbsp;BUY &nbsp;&nbsp;</a>
                </li><li class="nav-item"><a class="nav-link link text-black display-4" href="../sell.html"><span class="mbri-cash mbr-iconfont mbr-iconfont-btn"></span>
                        &nbsp;SELL  &nbsp;</a></li><li class="nav-item dropdown"><a class="nav-link link dropdown-toggle text-black display-4" href="https://mobirise.com" data-toggle="dropdown-submenu" aria-expanded="false">MORE</a><div class="dropdown-menu"><a class="dropdown-item text-black display-4" href="index.html">LOGOUT</a></div></li></ul>
            
        </div>
    </nav>
</section>

<section class="engine"></section><section class="header1 cid-qySY4JagbH mbr-parallax-background" id="header1-13" data-rv-view="145">
 <div class="container">
        <div class="row justify-content-md-center">
            <div class="mbr-white col-md-10">
                <h1 class="mbr-section-title align-center mbr-bold pb-3 mbr-fonts-style display-1 ">CHOOSE YOUR HOME SWEET HOME</h1>
...
<?php    
$result = pg_query($db,"SELECT * FROM property");
$p_array = pg_fetch_array($result,NULL,PGSQL_ASSOC);
    ...
    <div class="col-lg-4" style="padding-top: 10px">
      <div class="mbr-gallery-item mbr-gallery-item--pNaN" data-video-url="false" data-tags="Animated">
        <div href="#lb-gallery3-2t" data-slide-to="3" data-toggle="modal" align="center">
          <img src="<?php echo $p_array["image"]; ?>" alt="" width="300" height="300">
          <div align="center"><strong><?php echo $p_array["name"]; ?></strong></div>
          <div class="product-price" align="align-center"><?php echo "₹".$p_array["price"]; ?></div>
          <div class="product-size" align="align-center"><?php echo $p_array["size"]; ?></div>
